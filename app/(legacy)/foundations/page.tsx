...
import { catalogMaturityNote, catalogSummary, foundationItems } from "@/components/prism/catalog"
...
export default function FoundationsOverview() {
  return (
    <div className="components-overview foundations-language-page">
      ...
      <p>十项基础规范已有正文，承接 Token、视觉、布局、动效与无障碍约束。规范存在不等于对应组件已稳定；验证范围与待办见本页验证进度及各规范页。</p>
