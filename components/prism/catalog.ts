...
export const componentDocuments = {
  ...
  card: {
    ...
    eyebrow: "数据展示",
    title: "Card",
    description: "围绕同一对象组织身份、范围、结论、状态与操作；中性表面承托阅读，就近响应当前意图。",
    guidance: "默认无阴影，不因 AI 来源给整卡上色。同一张卡片最多一条内部分隔线，展开详情时同样适用；优先用间距、对齐与字阶组织分组。选择、展开、编辑与复核使用明确控件，各对象的状态独立。加载、失败保留已有结果；长内容自然增高，不能为了对齐截断依据。",
