  ...
  return <div className="object-card-workbench" data-density={showDensityControl ? localDensity : density}>
    ...
    <div className="object-card-grid">
      ...
      <ObjectCard aria-labelledby={`${id}-ai-title`} tone="ai" className="object-card--wide">
        ...
        <footer className="object-card-footer object-card-footer--divided">
    ...
    <section className="common-card-example" aria-labelledby={`${id}-resource-kind`}>
      ...
      <ObjectCard aria-labelledby={`${id}-resource-title`} className="common-card">
        <div className="common-card-body common-card-resource">
          <div className="common-card-document" aria-hidden="true"><FileText /></div>
