...
export function QuestionReview({question,attempts,initialScores,learner,description,initialNote,editor,onEditorChange,onConfirm}:QuestionReviewProps) {
  ...
  return <div className="space-y-6">
    <header className="space-y-2"><h3 className="text-lg font-semibold">{question.title}</h3><p className="text-sm text-muted-foreground">{learner?`${learner} · `:""}{question.id} · 原题 {question.points} 分</p><p className="text-sm text-muted-foreground">{description}</p></header>
