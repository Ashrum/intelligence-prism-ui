...
import { ArrowUpDown,ArrowRight,Bookmark,Clock,ChevronDown,FileText } from "lucide-react"
  ...
  <DemoSection title="内容与操作" description="用于材料摘要；状态与时长集中呈现，收藏和阅读分别位于两侧。">
   <Card className="prism-card-composed">
    ...
    <CardPanel>
     ...
     <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-2"><StatusBadge tone="pending">待复核</StatusBadge><span className="inline-flex items-center gap-1.5 text-[.8125rem] text-muted-foreground"><Clock className="size-3.5" aria-hidden="true"/>预计 8 分钟</span></div>
    </CardPanel>
