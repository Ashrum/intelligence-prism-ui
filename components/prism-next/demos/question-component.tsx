...
const listSamples=[questionSamples[0],questionSamples[3],compositeQuestion]
export function QuestionComponentDemo(){
 const [id,setId]=useState(samples[0].id),[listIds,setListIds]=useState(listSamples.map(q=>q.id))
 return <>
  <DemoSection title="独立题目卡片" description="题型与分值帮助扫读；题面、详情、作答与操作由调用方传入。">
