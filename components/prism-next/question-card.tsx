...
export function QuestionCard({question,number,metadata,detail,onDetailChange,links,onLinksChange,checked,onCheckedChange,actions,secondaryActions,reading=false,compact=false,status,detailStatus="可用",canEdit=false,header,showPoints=true,displayPoints,displayPartPoints}:{
  ...
  checked?:boolean;onCheckedChange?:(value:boolean)=>void;actions?:ReactNode;secondaryActions?:ReactNode;reading?:boolean;compact?:boolean;status?:ReactNode;detailStatus?:string;canEdit?:boolean;header?:ReactNode;showPoints?:boolean;displayPoints?:number;displayPartPoints?:Record<string,number>
}) {
  const id=useId()
