...
沿用 v1.13.1 已通过评审的 80 个组件基线，本版按参考图升级题卡及试题篮。包含 54 个 coss 基础组件、16 个组合组件、10 个扩展组件、3 套主题和 2 个应用示例；应用示例独立于组件，不计入组件数量。
...
- 题卡按序号、标题、题型与分值、题干和操作分层；新增无外框列表形式，并复用于试题篮。原有数据和操作接口兼容。
