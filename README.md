...
- 54 项 coss 官方基础组件和 1 项 Date Picker 日期组合均有可操作示例。旧目录的 59 项规划是历史记录，不等同于本版交付范围。
...
- `node --test tests/*.test.mjs`：旧功能回归、全部 55 条组件与组合路由、新旧根隔离、原始 coss 散列、旧内容保留、材料校验和 Agent 状态约束。
