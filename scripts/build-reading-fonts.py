...
if __name__ == "__main__":
    ...
    # Include prose symbols as well as ideographs. A single visible character
    ...
    manifest_path.write_text(json.dumps({"sources": sources, "files": files}, ensure_ascii=False, indent=2) + "\n")
